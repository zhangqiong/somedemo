            ...
            init: function () {
                el.each(function () {
                    ...
                    if (settings.dynamic == true) {
                        ...
                        $children = $(this).children().slice(settings.from);
            ...
            loadContent: function (index) {
                ...
                if (settings.mobileSrc === true && windowWidth <= settings.mobileSrcMaxWidth) {
                    ...
                    if (settings.dynamic == true) {
                        ...
                        $introduction=$children.eq(index).find('.introduction').clone();
                    }
                }
                if (!$this.isVideo(src)) {
                    $slide.eq(index).prepend($introduction);
                        ...
                        for (i = 0; i <= index - 1; i++) {
                            ...
                            if (settings.mobileSrc === true && windowWidth <= settings.mobileSrcMaxWidth) {
                                ...
                                if (settings.dynamic == true) {
                                    ...
                                    $introduction=$children.eq(index - i - 1).find('.introduction').clone();

                                }
                            }
                            if (!$this.isVideo(src)) {
                                $slide.eq(index - i - 1).prepend($introduction);
                        ...
                        for (j = 1; j < l; j++) {
                            ...
                            if (settings.mobileSrc === true && windowWidth <= settings.mobileSrcMaxWidth) {
                                ...
                                if (settings.dynamic == true) {
                                    ...
                                    $introduction=$children.eq(index+ j).find('.introduction').clone();

                                }
                            }
                            if (!$this.isVideo(src)) {
                                $slide.eq(index+ j).prepend($introduction);
